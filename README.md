...
- ➕ ストップウォッチの追加機能
- 🗑️ **ストップウォッチの削除機能**（各タイマーに削除ボタン付き）
- 📝 **各ストップウォッチにタスク名を設定可能**（例: 作業、休憩、勉強）
...
- 🎨 **超コンパクトUI**（400x600の小さなウィンドウ、アイコンボタン採用）
- ▶️ 各ストップウォッチで「▶（スタート）」「⏸（一時停止）」「↻（クリア）」「×（削除）」機能
- 📜 スクロール対応で多数のストップウォッチを管理可能
